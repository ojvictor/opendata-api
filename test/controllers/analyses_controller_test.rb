...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference('Analysis.count') do
      post analyses_url, params: { analysis: { analysis_date: @analysis.analysis_date, dw_best_pratice_id: @analysis.dw_best_pratice_id, maybe_false_positive: @analysis.maybe_false_positive, open_gov_principle_id: @analysis.open_gov_principle_id, page_id: @analysis.page_id, provide_api_reference: @analysis.provide_api_reference } }, as: :json
    end
