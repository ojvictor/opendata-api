...
class OpenGovPrinciplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create open_gov_principle" do
    assert_difference('OpenGovPrinciple.count') do
      post open_gov_principles_url, params: { open_gov_principle: { accessible: @open_gov_principle.accessible, complete: @open_gov_principle.complete, page_id: @open_gov_principle.page_id, primary: @open_gov_principle.primary } }, as: :json
    end
  ...
  test "should update open_gov_principle" do
    patch open_gov_principle_url(@open_gov_principle), params: { open_gov_principle: { accessible: @open_gov_principle.accessible, complete: @open_gov_principle.complete, page_id: @open_gov_principle.page_id, primary: @open_gov_principle.primary } }, as: :json
    assert_response 200
  end
